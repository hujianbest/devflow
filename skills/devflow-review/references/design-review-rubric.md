...
## 组件设计质量检查（原组件模板第 9 章，由 reviewer 承担）
...
这些内容由 reviewer 从组件模板第 1–8 章、delta-design、canonical diff 与证据中综合
判断，不要求在 `component-design-template.md` 中恢复独立第 9 章。任一关键结论缺少
可审查依据时形成 finding，不能以“模板没有该章节”为 N/A 理由。
