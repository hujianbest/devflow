# devflow Definition of Done

> 配套 `devflow-completion-gate/SKILL.md`。规定 devflow 单 AR / DTS work item 及其 Current Active Task 在不同 profile 下的完成定义。
...
| 条件 | conclusion | 下一步 |
|---|---|---|
| Task-Level DoD 满足且存在唯一 next-ready task，无 critical-open，本轮验证全绿 | `通过` | `devflow-tdd-implementation`（锁定 next-ready task） |
