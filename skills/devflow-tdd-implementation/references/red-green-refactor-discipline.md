# devflow RED / GREEN / REFACTOR Discipline

> 配套 `devflow-tdd-implementation/SKILL.md`。规定 devflow 中 TDD 步骤的纪律、Two Hats、Fowler vocabulary 与升级边界。
...
4. **不调整 AR 设计**：发现 AR 设计有误 → 停下回 `devflow-ar-design`，不在 TDD 中悄悄改设计
...
4. 由 router 路由到 `devflow-component-design` / `devflow-ar-design` / 重升 component-impact
...
- Escalation Triggers: <None | escalate to devflow-router>
