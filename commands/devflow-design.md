...
3. 叠加适用的语言规范（`<language>-coding-standards`，如 c/cpp/java/python）与领域约束（`embedded-development` / `automotive-coding-standards` / `frontend-development` / `backend-development`）。
