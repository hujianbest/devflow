...
<passed：进入下一阶段；rework：回 devflow-specify / devflow-design / devflow-tdd 中的一个；需要人裁决：列出最小问题>
...
建议返工阶段只能指向现有阶段技能：`devflow-specify`、`devflow-design`、`devflow-tdd`。测试和代码评审中的普通缺陷默认指向 `devflow-tdd`；只有证明规格或设计本身错误时，才指向更上游阶段。
